...
use App\Http\Controllers\ManufactDashboard;
...
Route::middleware(ProtectAgainstSpam::class)->group(function () {
	...
	Route::middleware(['checkinstallation'])->group(function () {
		...
		Route::middleware(['countrylistbub', 'throttle:refresh', 'ipblockunblock', 'apichecking'])->group(function () {
			...
			Route::redirect('/','/manufact/box')->name('Home');
		...
		Route::group(['namespace' => 'Manufact', 'prefix'	 => 'manufact'], function () {
			Route::middleware('auth', 'admin.auth')->group(function () {
				Route::get("/",[ManufactDashboard::class,'index'])->name("manufact.dashboard");
				Route::get("/box", [BoxController::class, 'index'])->name("box.index");
				Route::get("/box/get-list", [BoxController::class, 'getBoxList'])->name("box.get.list");
				Route::get("/box/create", [BoxController::class, 'create'])->name("box.create.form");
				Route::post("/box/create-box", [BoxController::class, 'createBox'])->name("box.create");
				Route::get("/box/detail/{id}", [BoxController::class, 'show'])->name("box.detail");
				Route::get("/box/pdf/label/{id}", [BoxController::class, 'pdfLabelBox'])->name("box.pdf.label");
