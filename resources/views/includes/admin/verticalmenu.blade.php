                    ...
                    <aside class="app-sidebar">
                        ...
                        <div class="app-sidebar3">
                                    ...
                                    <div class="user-pic">
                                        ...
                                        @else
                                            <img src="{{ asset('uploads/profile/' . Auth::user()->image) }}"
                                                class="avatar-xxl rounded-circle mb-1" alt="{{ Auth::user()->image }}">
                                        @endif
                            ...
                            <ul class="side-menu custom-ul">
                                @role('supervisor')
                                    <li class="slide">
                                        <a class="side-menu__item" href="{{ url('manufact/') }}">
                                    ...
                                    <li>
                                        <a class="side-menu__item" href="{{ route('box.index') }}">
                                            ...
                                            <span class="side-menu__label">{{ trans('Box') }}</span>
                                        </a>
                                            ...
                                            <ul class="slide-menu custom-ul">
                                                ...
                                                @can('SEO Access')
                                                    <li><a href="{{ url('/admin/seo') }}"
                                                            class="slide-item">{{ trans('langconvert.adminmenu.seo') }}</a></li>
                                                @endcan
